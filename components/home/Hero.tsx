          ...
          <div className="flex-1 text-center lg:text-left z-10 lg:mt-2">
            ...
            >
              ...
              <Button 
                ...
                size="lg"
                asChild
                className="w-full sm:w-auto rounded-full border-2 border-ink-900 text-ink-900 px-8 sm:px-10 h-14 text-base sm:text-lg font-semibold bg-transparent hover:bg-ink-900 hover:text-background transition-all"
              >
